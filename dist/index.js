...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return iframeInjector; });
...
function () {
  function iframeInjector() {
    _babel_runtime_corejs2_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, iframeInjector);

    this.iframes = new _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_0___default.a();
  } // parseStyle(styleObj) {
  // }
  ...
  _babel_runtime_corejs2_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(iframeInjector, [{
    key: "inject",
    value: function inject(_ref) {
      var src = _ref.src,
          style = _ref.style;
      var id = uuid_v4__WEBPACK_IMPORTED_MODULE_3___default()(); // const iframe = this.createElement({ id, src, style });
